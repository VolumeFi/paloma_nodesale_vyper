...
def main():
    start_timestamp = 1722988800        # Aug 7 gmt+0, real start timesetamp Aug 14 gmt+0 1723593600
    end_timestamp = 1728000000          # Oct 4 gmt+0
    processing_fee = 5000000            # 5 USDC
    subscription_fee = 50000000         # 50 USDC per month
    referral_discount_percentage = 500  # 5%
    referral_reward_percentage = 1500   # 15%
    ...
    with networks.parse_network_choice("arbitrum:mainnet:alchemy") as provider:
        ...
        palomaNodeSale = project.PalomaNodeSale.deploy(compass, swap_router, reward_token, admin, fund_receiver, fee_receiver, start_timestamp, end_timestamp, processing_fee, subscription_fee, referral_discount_percentage, referral_reward_percentage, sender=acct)
        print(palomaNodeSale)
    
    # # ETH
    # with networks.parse_network_choice("ethereum:mainnet:alchemy") as provider:
    #     acct = accounts.load("Deployer")
    #     compass = "0x4E74982adB77496308f9c16e45966264D1A4e596"
    #     swap_router = "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45"      # SWAP_ROUTER_02
    ...
    #     acct = accounts.load("Deployer")
    #     compass = "0x9d703a2bE7ac576454fa310Aca1c667D1D5e8081"
    ...
    #     acct = accounts.load("Deployer")
    #     compass = "0xEf4E24B1a9aAb82e7a0a2e238E7815Cd9A566c48"
    #     swap_router = "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45"      # SWAP_ROUTER_02
    ...
    #     acct = accounts.load("Deployer")
    #     compass = "0x978A72B76ddDFD603b0261Adb4FB0D7Bb09f6AA6"
    ...
    #     acct = accounts.load("Deployer")
    #     compass = "0xa9Ff4c11B1B5c898E2037063C8641fe5A1EBEF26"
    #     swap_router = "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45"      # SWAP_ROUTER_02
